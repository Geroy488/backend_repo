...
async function initialize() {
  ...
  try {
    console.log(`🔗 Connecting to PostgreSQL database "${database}" at ${host}:${port} (${isDev ? 'local' : 'production'})`);
    ...
    // ===============================
    await sequelize.sync({ alter: isDev }); // Only auto-alter in development
